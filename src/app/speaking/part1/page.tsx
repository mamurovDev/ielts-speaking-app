...
export default function Page() {
  ...
  return (
    <>
      <SEO title="IELTS speaking Part 1 Practice" lang="en-US" canonicalTag={""} description={`Explore a diverse range of topics, including ${topics}, with insightful questions and answers. Discover valuable insights about ${topics} and gain knowledge to enhance your understanding and experience.`}
