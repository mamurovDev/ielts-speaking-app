...
export default function Page() {
  ...
  return (
    <>
      <SEO title="IELtS speaking Part 1 Practice" lang="en-US" canonicalTag={currentRoute} description={`Explore a diverse range of topics, including ${topics}, with insightful questions and answers. Discover valuable insights about ${topics} and gain knowledge to enhance your understanding and experience.`}
